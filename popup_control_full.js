...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://aodongphuclop.net/gia-thong-tin-ao-dong-phuc-lop/' target='_blank'><img src='https://raw.githubusercontent.com/ngoctho12/hinh/master/dong-phuc-nhom-lop-01.jpg' width='500px'/>Mẫu may áo đồng phục lớp mới nhất</a>. Tại mayaothundongphuc.net <h2><a class='close-linhnguyen-modal'>X</a></h2>");
